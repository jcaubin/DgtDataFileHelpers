...
namespace ConsoleDgtData
{
    public class VehicInputData
    {
        ...
        [FieldFixedLength(6)]
        [FieldTrim(TrimMode.Both)]
        public int? MasaMáximaTecnicaAdmisibleItv;
